...
local function copy_line_diagnostics_to_clipboard()
	...
	if #diagnostics == 0 then
		print("JWE: no diagnostics on the current line.")
		Snacks.notify.info("JWE: no diagnostics on the current line.")
		return
	end
	...
	Snacks.notify.info("JWE: diagnostics copied to clipboard.")
end
